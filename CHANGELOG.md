...
## [0.3.0](https://github.com/morellodev/arbor/compare/v0.2.0...v0.3.0) - 2026-03-14
...
- release v0.2.0
- fix release pipeline by using GITHUB_TOKEN for tagging
- fix artifact action versions in release workflow
