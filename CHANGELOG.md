...
- per-project worktree directory override via .arbor.toml

### Other

- gate release PR on CI success

## [0.2.3](https://github.com/morellodev/arbor/compare/v0.2.2...v0.2.3) - 2026-03-16

### Added

- interactive shell init setup with --inject flag
